...
function onstartswitch(){
    ...
    document.getElementById('switchnoti').innerHTML = "Switch to Class: "+json.records[i].Class+" <svg xmlns='http://www.w3.org/2000/svg fill='currentColor' width='20px' height='20px' style='background-color:white;margin-left:10px;padding:2px;margin-top:-4px;' class='bi bi-arrow-left-right' viewBox='0 0 16 16'>"+
...
clsrmcmntfm.reset();
  ...
  function rfshcmnt(){
   ...
   function totlcmnt(nof){
    document.getElementById('allcmntsnm').innerHTML = 'All Comments '+'('+nof+')';
  }