  ...
  var t = {
        ...
        var c = (function () {
          function t(e, n) {
            ...
            (this.lightPosition = this.w - 1),
              (this.wrapper = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper"
              )),
              (this.input = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper .ptro-color"
              )),
              (this.pipetteButton = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper button.ptro-pipette"
              )),
              (this.closeButton = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper button.ptro-close-color-picker"
              )),
              (this.canvas = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper canvas"
              )),
              (this.ctx = this.canvas.getContext("2d")),
              (this.canvasLight = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper .ptro-canvas-light"
              )),
              (this.colorRegulator = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper .ptro-color-light-regulator"
              )),
              (this.canvasAlpha = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper .ptro-canvas-alpha"
              )),
              (this.alphaRegulator = e.wrapper.querySelector(
                ".ptro-color-widget-wrapper .ptro-color-alpha-regulator"
              )),
              (this.ctxLight = this.canvasLight.getContext("2d")),
              (this.ctxAlpha = this.canvasAlpha.getContext("2d")),
              this.canvas.setAttribute("width", "".concat(o)),
              this.canvas.setAttribute("height", "".concat(i)),
              this.canvasLight.setAttribute("width", "".concat(o)),
              this.canvasLight.setAttribute("height", "".concat(20)),
              this.canvasAlpha.setAttribute("width", "".concat(o)),
              this.canvasAlpha.setAttribute("height", "".concat(20));
            var a = this.ctx.createLinearGradient(0, 0, o, 0);
            a.addColorStop(1 / 15, "#ff0000"),
              a.addColorStop(4 / 15, "#ffff00"),
              a.addColorStop(5 / 15, "#00ff00"),
              a.addColorStop(0.6, "#00ffff"),
              a.addColorStop(0.8, "#0000ff"),
              a.addColorStop(14 / 15, "#ff00ff"),
              (this.ctx.fillStyle = a),
              this.ctx.fillRect(0, 0, o, i);
            var l = this.ctx.createLinearGradient(0, 0, 0, i);
            l.addColorStop(0, "rgba(0, 0, 0, 0)"),
              l.addColorStop(0.99, "rgba(0, 0, 0, 1)"),
              ...
              (this.pipetteButton.onclick = function () {
                r.wrapper.setAttribute("hidden", "true"),
                  (r.opened = !1),
                  (r.choosing = !0);
              }),
            ...
            (A = [
              {
                ...
                value: function () {
                  return (
                    '<div class="ptro-color-widget-wrapper ptro-common-widget-wrapper ptro-v-middle" hidden><div class="ptro-pallet ptro-color-main ptro-v-middle-in"><canvas></canvas><canvas class="ptro-canvas-light"></canvas><span class="ptro-color-light-regulator ptro-bordered-control"></span><canvas class="ptro-canvas-alpha"></canvas><span class="alpha-checkers"></span><span class="ptro-color-alpha-regulator ptro-bordered-control"></span><div class="ptro-colors"></div><div class="ptro-color-edit"><button type="button" class="ptro-icon-btn ptro-pipette ptro-color-control" style="float: left; margin-right: 5px"><i class="ptro-icon ptro-icon-pipette"></i></button><input class="ptro-input ptro-color" type="text" size="7"/><button type="button" class="ptro-named-btn ptro-close-color-picker ptro-color-control" >' +
                    "".concat((0, r.tr)("close"), "</button>") +
                    "</div></div></div>"
                  );
                },
              },
            ...
            (n = [
              {
                ...
                value: function (t, e) {
                  (this.target = t.target),
                    ...
                    this.drawLighter(),
                    (this.colorRegulator.style.left = "".concat(
                      this.lightPosition,
                      "px"
                    )),
                    (this.alphaRegulator.style.left = "".concat(
                      Math.round(this.alpha * this.w),
                      "px"
                    )),
                    this.regetColor(),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (n = n < 1 ? 1 : n),
                    (e = ((e = e < 1 ? 1 : e) > this.w && this.w - 1) || e),
                    (n = (n > this.h && this.h - 1) || n);
                  var r = this.ctx.getImageData(e, n, 1, 1).data;
                  (this.palleteColor = s(r[0], r[1], r[2])),
                    this.drawLighter(),
                    this.regetColor();
                },
              },
              {
                key: "regetColor",
                value: function () {
                  var t = this.ctxLight.getImageData(
                    this.lightPosition,
                    5,
                    1,
                    1
              ...
              },
              {
                key: "regetAlpha",
                value: function () {
                  var t = this.ctxAlpha.getImageData(
                    this.alphaPosition,
                    5,
                    1,
                    1
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (e = ((e = e < 1 ? 1 : e) > this.w - 1 && this.w - 1) || e),
                    (this.lightPosition = e),
                    (this.colorRegulator.style.left = "".concat(e, "px")),
                    this.regetColor();
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  (e = ((e = e < 1 ? 1 : e) > this.w - 1 && this.w - 1) || e),
                    ...
                    (this.alphaRegulator.style.left = "".concat(e, "px")),
                    this.regetAlpha();
                },
              },
              {
                ...
                value: function (t) {
                  return (
                    !(!this.opened || t.keyCode !== o.KEYS.enter) ||
                    (!(!this.opened || t.keyCode !== o.KEYS.esc) &&
                      (this.close(), !0))
                  );
                },
              },
              {
                key: "handleMouseDown",
                value: function (t) {
                  return this.choosing && 2 !== t.button
                    ? ((this.choosingActive = !0), this.handleMouseMove(t), !0)
                    : ((this.choosing = !1),
                      t.target === this.canvas &&
                        ((this.selecting = !0), this.getPaletteColorAtPoint(t)),
                      (t.target !== this.canvasLight &&
                        t.target !== this.colorRegulator) ||
                        ((this.lightSelecting = !0),
                        this.getColorLightAtClick(t)),
                      (t.target !== this.canvasAlpha &&
                        t.target !== this.alphaRegulator) ||
                        ((this.alphaSelecting = !0), this.getAlphaAtClick(t)),
                      !1);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  (this.input.style["background-color"] = t),
                    ...
                    (this.color = t),
                    (this.alphaColor = l(t, this.alpha)),
                    void 0 !== this.callback &&
                      this.opened &&
                      this.callback({
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.addColorStop(0, "#ffffff"),
                    t.addColorStop(0.05, "#ffffff"),
                    t.addColorStop(0.95, this.palleteColor),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.addColorStop(0, "rgba(255,255,255,0)"),
                    t.addColorStop(0.05, "rgba(255,255,255,0)"),
                    t.addColorStop(0.95, this.color),
            ...
            (n = [
              {
                ...
                value: function (e) {
                  var n = this,
                    o = function () {
                      var t = n.main.getElemByIdSafe(
                        n.main.activeTool.controls[e].id
                      ).value;
                      n.main.textTool.setFontSize(t),
                        (0, r.setParam)("defaultFontSize", t);
                    },
                    i = function () {
                      return n.main.textTool.fontSize;
                    };
                  return this.main.params.availableFontSizes
                    ? t.buildDropDownControl(
                        "fontSize",
                        o,
                        i,
                        this.main.params.availableFontSizes
                      )
                    : t.buildInputControl("fontSize", o, i, 1, 200);
                },
              },
              {
                ...
                value: function (e) {
                  var n = this,
                    o = function () {
                      ...
                      n.main.primitiveTool.setEraserWidth(t),
                        (0, r.setParam)("defaultEraserWidth", t);
                    },
                    i = function () {
                      return n.main.primitiveTool.eraserWidth;
                    };
                  return this.main.params.availableEraserWidths
                    ? t.buildDropDownControl(
                        "eraserWidth",
                        o,
                        i,
                        this.main.params.availableEraserWidths
                      )
                    : t.buildInputControl("eraserWidth", o, i, 1, 99);
                },
              },
              {
                ...
                value: function (e) {
                  var n = this,
                    o = function () {
                      ...
                      n.main.primitiveTool.setLineWidth(t),
                        (0, r.setParam)("defaultLineWidth", t);
                    },
                    i = function () {
                      return n.main.primitiveTool.lineWidth;
                    };
                  return this.main.params.availableLineWidths
                    ? t.buildDropDownControl(
                        "lineWidth",
                        o,
                        i,
                        this.main.params.availableLineWidths
                      )
                    : t.buildInputControl("lineWidth", o, i, 0, 99);
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  return {
                    ...
                    target: "shadowOn",
                    action: function () {
                      var n = e.main.getElemByIdSafe(
                          e.main.activeTool.controls[t].id
                        ),
                        o = !("true" === n.getAttribute("data-value"));
                      e.main.primitiveTool.setShadowOn(o),
                        n.setAttribute("data-value", o ? "true" : "false"),
                        (0, r.setParam)("defaultPrimitiveShadowOn", o);
                    },
                    getValue: function () {
              ...
              },
              {
                ...
                value: function (e) {
                  var n = this;
                  return t.buildInputControl(
                    "lineWidth",
                    function () {
                      var t = document.getElementById(
                        n.main.activeTool.controls[e].id
                      ).value;
                      console.log("buildPaintBucketControl width: " + t),
                        (0, r.setParam)("activeFillColor", t);
                    },
                    function () {
                      return n.main.primitiveTool.lineWidth;
                    },
                ...
                value: function (e) {
                  var n = this,
                    o = function () {
                      ...
                      n.main.primitiveTool.setArrowLength(t),
                        (0, r.setParam)("defaultArrowLength", t);
                    },
                    i = function () {
                      return n.main.primitiveTool.arrowLength;
                    };
                  return this.main.params.availableArrowLengths
                    ? t.buildDropDownControl(
                        "arrowLength",
                        o,
                        i,
                        this.main.params.availableArrowLengths
                      )
                    : t.buildInputControl("arrowLength", o, i, 1, 99);
                },
              },
            ]) && o(e.prototype, n),
            i && o(e, i),
        ...
        var a = (function () {
          function t(e) {
            ...
            var r = {
                extend_top: {
                  ...
                  handle: function (t) {
                    ...
                    if (
                      (n.main.resize(i, o),
                      n.main.clearBackground(),
                      n.ctx.putImageData(a, 0, t.naturalHeight),
                      n.main.adjustSizeFull(),
                      t.naturalWidth < r)
                    ) {
                ...
                extend_left: {
                  ...
                  handle: function (t) {
                    ...
                    if (
                      (n.main.resize(o, i),
                      n.main.clearBackground(),
                      n.ctx.putImageData(a, t.naturalWidth, 0),
                      n.main.adjustSizeFull(),
                      t.naturalHeight < e)
                    ) {
              ...
              o = {
                replace_all: {
                  internalName: "fit",
                  handle: function (t) {
                    n.main.params.backplateImgUrl &&
                      ((n.main.params.backplateImgUrl = void 0),
                      (n.main.tabelCell.style.background = ""),
                      (n.main.canvas.style.backgroundColor = "".concat(
                        n.main.params.backgroundFillColor,
                        "ff"
                      )),
                      (n.pasteOptions = Object.assign({}, o, r)),
                      (n.activeOption = n.pasteOptions),
                      n.main.wrapper
                        .querySelector(".ptro-paster-select-wrapper")
                        .remove(),
                      n.main.wrapper.insertAdjacentHTML("beforeend", n.html()),
                      n.init(e)),
                      n.main.fitImage(t, n.mimetype);
                  },
                },
                paste_over: {
                  internalName: "over",
                  handle: function (t) {
                    ...
                    var e = n.main.size.h,
                      r = n.main.size.w;
                    if (t.naturalHeight <= e && t.naturalWidth <= r)
                      n.main.select.placeAt(
                        0,
                        0,
                        r - t.naturalWidth,
                        e - t.naturalHeight,
            ...
            if (this.main.params.backplateImgUrl)
              return (
                (this.pasteOptions = Object.assign({}, o)),
                void (this.activeOption = this.pasteOptions)
              );
            (this.pasteOptions = Object.assign({}, o, r)),
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    '<button type="button" id="'
                      .concat(
                        t.id,
                        '" class="ptro-selector-btn ptro-color-control '
                      )
                      .concat(e, '">') +
                      '<div><i class="ptro-icon ptro-icon-paste_'.concat(
                        t.internalName,
                        '"></i></div>'
                      ) +
                      "<div>".concat(
                        (0, r.tr)("pasteOptions.".concat(t.internalName)),
                        "</div>"
                      ) +
                      "</button>"
                  );
            ...
            (n = [
              {
                ...
                value: function (t) {
                  ...
                  (this.CLIP_DATA_MARKER = "painterro-image-data"),
                    ...
                    (this.selector = t.wrapper.querySelector(
                      ".ptro-paster-select-wrapper"
                    )),
                    this.cancelChoosing(),
                    (this.img = null),
                    (this.mimetype = null),
                    this.getAvailableOptions().forEach(function (t) {
                      var n = e.pasteOptions[t];
                      e.main.getElemByIdSafe(n.id).onclick = function () {
                        e.loading ? (e.doLater = n.handle) : n.handle(e.img),
                          e.cancelChoosing();
                      };
                    }),
                    (this.loading = !1),
              ...
              },
              {
                key: "insert",
                value: function (t, e, n, r) {
                  this.main.ctx.drawImage(this.tmpImg, t, e, n, r),
              ...
              },
              {
                ...
                value: function (t, e) {
                  (this.img = t),
                    (this.mimetype = e),
                    (this.loading = !1),
                    this.doLater && (this.doLater(t), (this.doLater = null));
                },
              },
              {
                ...
                value: function () {
                  var t = this;
                  return this.main.params.how_to_paste_actions
                    ? Object.keys(this.activeOption).filter(function (e) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  var r = function (t) {
                    var r = new Image(),
                      o =
                        n.main.worklog.clean &&
                        n.main.params.replaceAllOnEmptyBackground;
                    if (
                      ((r.onload = function () {
                        o ? n.main.fitImage(r, e) : n.loaded(r, e),
                          n.finishLoading();
                      }),
                      (r.onerror = function () {
                        "function" == typeof n.main.params.onImageFailedOpen &&
                          n.main.params.onImageFailedOpen();
                      }),
                      (r.src = t),
                      !o)
                    ) {
                      ...
                      1 !== i.length
                        ? (n.selector.removeAttribute("hidden"),
                          (n.waitChoice = !0))
                        : (n.doLater = n.activeOption[i[0]].handle);
                    }
                  };
                  0 !== t.indexOf("data")
                    ? (0, o.imgToDataURL)(
                        ...
                        function () {
                          "function" ==
                            typeof n.main.params.onImageFailedOpen &&
                            n.main.params.onImageFailedOpen();
                        }
                      )
                    : r(t);
              ...
              },
              {
                key: "handleKeyDown",
                value: function (t) {
                  return this.waitChoice && t.keyCode === o.KEYS.esc
                    ? (this.cancelChoosing(), !0)
                    : !(!this.waitChoice || event.keyCode !== o.KEYS.enter);
                },
              },
              {
                key: "startLoading",
                value: function () {
                  if (
                    ((this.loading = !0), this.main.toolByName.open.buttonId)
                  ) {
                    var t = this.main.getElemByIdSafe(
                      this.main.toolByName.open.buttonId
                    );
                    t && t.setAttribute("disabled", "true");
                    var e = this.main.doc.querySelector(
                      "#".concat(this.main.toolByName.open.buttonId, " > i")
                    );
                    e &&
                      (e.className =
                        "ptro-icon ptro-icon-loading ptro-spinning");
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    i = "";
                  return (
                    this.getAvailableOptions().forEach(function (n) {
                      "replace_all" === n || "paste_over" === n
                        ? (o += '<div class="ptro-paster-fit">\n          '
                            .concat(
                              t.controlObjToString(
                                e.pasteOptions[n],
                                "ptro-selector-fit"
                              ),
                            ...
                            .concat(
                              (0, r.tr)(
                                "pasteOptions.".concat(
                                  e.pasteOptions[n].internalName
                                )
                              ),
                              "\n        </div></div>"
                            ))
                        : (i += t.controlObjToString(
                            e.pasteOptions[n],
                            "ptro-selector-extend"
                          ));
                    }),
                    '<div class="ptro-paster-select-wrapper" hidden><div class="ptro-paster-select ptro-v-middle"><div class="ptro-in ptro-v-middle-in">' +
        ...
        var x = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (0, l.addDocumentObjectHelpers)(),
              (this.getElemByIdSafe = function (t) {
                if (!t)
                  throw new Error(
                    "Can't get element with id=".concat(
                      t,
                      ", please create an issue here, we will easily fx it: https://github.com/devforth/painterro/issues/"
                    )
                  );
              ...
              (this.tools = [
                {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      (n.toolContainer.style.cursor = "crosshair"),
                      n.select.activate(),
                      n.select.draw();
                  },
                  close: function () {
                ...
                },
                {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      (n.toolContainer.style.cursor = "crosshair"),
                      n.primitiveTool.activate("arrow");
                  },
                  eventListner: function () {
                    return n.primitiveTool;
                  },
                ...
                },
                {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      (n.toolContainer.style.cursor = "crosshair"),
                      n.primitiveTool.activate("ellipse");
                  },
                  eventListner: function () {
                    return n.primitiveTool;
                  },
                },
                {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      (n.toolContainer.style.cursor = "crosshair"),
                      n.primitiveTool.activate("brush");
                  },
                  eventListner: function () {
                    return n.primitiveTool;
                  },
                },
                {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      (n.toolContainer.style.cursor = "crosshair"),
                      n.primitiveTool.activate("eraser");
                  },
                  eventListner: function () {
                    return n.primitiveTool;
                  },
                },
                {
                  ...
                  controls: [
                    ...
                    function () {
                      return {
                        ...
                        target: "fontName",
                        action: function () {
                          var t = n.getElemByIdSafe(
                            n.activeTool.controls[2].id
                          ).value;
                    ...
                    function () {
                      return {
                        ...
                        action: function () {
                          var t = n.getElemByIdSafe(
                              n.activeTool.controls[3].id
                            ),
                            e = !("true" === t.getAttribute("data-value"));
                          n.textTool.setFontIsBold(e),
                            (0, c.setParam)("defaultFontBold", e),
                            t.setAttribute("data-value", e ? "true" : "false");
                        },
                        getValue: function () {
                    ...
                    function () {
                      return {
                        ...
                        action: function () {
                          var t = n.getElemByIdSafe(
                              n.activeTool.controls[4].id
                            ),
                            e = !("true" === t.getAttribute("data-value"));
                          n.textTool.setFontIsItalic(e),
                            (0, c.setParam)("defaultFontItalic", e),
                            t.setAttribute("data-value", e ? "true" : "false");
                        },
                        getValue: function () {
                    ...
                    function () {
                      return {
                        ...
                        action: function () {
                          var t = n.getElemByIdSafe(
                              n.activeTool.controls[5].id
                            ),
                            e = !("true" === t.getAttribute("data-value"));
                          n.textTool.setStrokeOn(e),
                            (0, c.setParam)("defaultTextStrokeAndShadow", e),
                            t.setAttribute("data-value", e ? "true" : "false");
                        },
                        getValue: function () {
                  ...
                  activate: function () {
                    n.initText && n.wrapper.click(),
                      n.textTool.setFontColor(
                        n.colorWidgetState.line.alphaColor
                      ),
                      (n.toolContainer.style.cursor = "crosshair");
                  },
                  close: function () {
                ...
                },
                {
                  ...
                  activate: function () {
                    ...
                    (o.width = t),
                      (o.height = e),
                      o.getContext("2d").putImageData(r, 0, 0),
                      n.resize(e, t),
                      n.ctx.save(),
                      n.ctx.translate(e / 2, t / 2),
                      n.ctx.rotate((90 * Math.PI) / 180),
                      n.ctx.drawImage(o, -t / 2, -e / 2),
                      n.adjustSizeFull(),
                      n.ctx.restore(),
                      n.worklog.captureState(),
                      n.closeActiveTool();
                ...
                },
                {
                  ...
                  activate: function () {
                    ...
                    n.curCord = [
                      e.clientX - n.elLeft() + n.scroller.scrollLeft,
                      e.clientY - n.elTop() + n.scroller.scrollTop,
                    ];
                    var r = n.getScale();
                    (n.curCord = [n.curCord[0] * r, n.curCord[1] * r]),
                      n.zoomImage(e);
                  },
                },
                {
                ...
                },
                {
                  ...
                  activate: function () {
                    (n.toolContainer.style.cursor = "crosshair"),
                      n.primitiveTool.activate("bucket");
                  },
                  eventListner: function () {
                ...
                },
                {
                  ...
                  activate: function () {
                    ...
                    n.params.onBeforeClose
                      ? n.params.onBeforeClose(n.hasUnsaved, t)
                      : t();
                  },
                },
              ]),
              (this.params = (0, c.setDefaults)(
                e,
              ...
              (this.controlBuilder = new m.default(this)),
              (this.isMobile = o.default.any),
              (this.toolByName = {}),
              (this.toolByKeyCode = {}),
              this.tools.forEach(function (t) {
                if (
                  (t.controls &&
                    (t.controls = t.controls.map(function (t) {
                      return t();
                    })),
                  (n.toolByName[t.name] = t),
                  t.hotkey instanceof Function && (t.hotkey = t.hotkey()),
                  t.hotkey && !n.params.hiddenTools.includes(t.name))
                ) {
                  if (!l.KEYS[t.hotkey])
                    throw new Error(
                      "Key code for ".concat(t.hotkey, " not defined in KEYS")
                    );
              ...
              void 0 === this.id
                ? ((this.id = (0, l.genId)()),
                  ...
                  (this.holderEl.innerHTML = "<div id='".concat(
                    this.id,
                    '\' class="ptro-holder"></div>'
                  )),
            ...
            this.tools
              ...
              .forEach(function (t) {
                ...
                t.buttonId = e;
                var n = t.hotkey
                    ? " [".concat(t.hotkey.toUpperCase(), "]")
                    : "",
                  o =
                    '<button type="button" class="ptro-icon-btn ptro-color-control" title="'
                      .concat((0, p.tr)("tools.".concat(t.name)))
                      .concat(n, '" ') +
                    'id="'.concat(e, '" >') +
                    '<i class="ptro-icon ptro-icon-'.concat(
                      t.name,
                      '"></i></button>'
                    );
                t.right ? (B += o) : (r += o);
            ...
            var v =
              ...
              "".concat(i.default.code()).concat(u.default.code(), "</div>");
            (this.loadedName = ""),
              (this.doc = document),
              (this.wrapper = this.doc.createElement("div")),
              (this.wrapper.id = "".concat(this.id, "-wrapper")),
              (this.wrapper.className = "ptro-wrapper"),
              (this.wrapper.innerHTML =
                '<div class="ptro-scroller"><div class="ptro-center-table"><div class="ptro-center-tablecell">' +
                '<canvas id="'.concat(this.id, '-canvas"></canvas>') +
                '<div class="ptro-substrate"></div>'.concat(v) +
                "</div></div>" +
                "</div>".concat(
                  s.default.html() +
                    h.default.html() +
              ...
              (this.scroller = this.doc.querySelector(
                "#".concat(this.id, "-wrapper .ptro-scroller")
              )),
              (this.bar = this.doc.createElement("div")),
              (this.bar.id = "".concat(this.id, "-bar")),
              (this.bar.className = "ptro-bar ptro-color-main"),
              (this.fileInputId = (0, l.genId)()),
              (this.bar.innerHTML =
                "<div>".concat(r) +
                '<span class="ptro-tool-controls"></span><span class="ptro-info"></span>' +
                '<span class="ptro-bar-right">'.concat(B, "</span>") +
                '<input id="'.concat(
                  this.fileInputId,
                  '" type="file" style="display: none" value="none" accept="image/x-png,image/png,image/gif,image/jpeg" /></div>'
                )),
            ...
            if (
              ((w.type = "text/css"),
              (w.innerHTML = this.params.styles),
              this.baseEl.appendChild(w),
              (this.saveBtn = this.baseEl.querySelector(
                "#".concat(this.toolByName.save.buttonId)
              )),
              this.toolByName.save.buttonId &&
                this.saveBtn &&
                this.saveBtn.setAttribute("disabled", "true"),
              (this.body = this.doc.body),
              (this.info = this.doc.querySelector(
                "#".concat(this.id, "-bar .ptro-info")
              )),
              (this.canvas = this.doc.querySelector(
                "#".concat(this.id, "-canvas")
              )),
              (this.ctx = this.canvas.getContext("2d")),
              (this.toolControls = this.doc.querySelector(
                "#".concat(this.id, "-bar .ptro-tool-controls")
              )),
              (this.toolContainer = this.doc.querySelector(
                "#".concat(this.id, "-wrapper .ptro-crp-el")
              )),
              (this.substrate = this.doc.querySelector(
                "#".concat(this.id, "-wrapper .ptro-substrate")
              )),
              (this.zoomHelper = new h.default(this)),
              (this.zoomButtonActive = !1),
              (this.select = new i.default(this, function (t) {
                [n.toolByName.crop, n.toolByName.pixelize].forEach(function (
                  e
                ) {
              ...
              (this.tabelCell = this.canvas.parentElement),
                (this.tabelCell.style.backgroundImage = "url(".concat(
                  this.params.backplateImgUrl,
                  ")"
                )),
              ...
              var b = new Image();
              (b.onload = function () {
                n.resize(b.naturalWidth, b.naturalHeight),
                  n.adjustSizeFull(),
                  n.worklog.captureState(),
                  (n.tabelCell.style.backgroundSize = ""
                    .concat(window.getComputedStyle(n.substrate).width, " ")
                    .concat(window.getComputedStyle(n.substrate).height));
              }),
                (b.src = this.params.backplateImgUrl);
            }
            (this.resizer = new d.default(this)),
              (this.settings = new g.default(this)),
              (this.primitiveTool = new A.default(this)),
              this.primitiveTool.setShadowOn(
                this.params.defaultPrimitiveShadowOn
              ),
              ...
              (this.hasUnsaved = !1),
              (this.worklog = new a.default(this, function (t) {
                n.saveBtn &&
                  !t.initial &&
                  (n.saveBtn.removeAttribute("disabled"), (n.hasUnsaved = !0)),
                  n.setToolEnabled(n.toolByName.undo, !t.first),
                  n.setToolEnabled(n.toolByName.redo, !t.last),
                  n.params.onChange &&
                    n.params.onChange.call(n, {
                      image: n.imageSaver,
              ...
              (this.paintBucket = new C.default(this)),
              (this.textTool = new u.default(this)),
              (this.colorPicker = new s.default(this, function (t) {
                (n.colorWidgetState[t.target] = t),
                  (n.doc.querySelector(
                    "#"
                      .concat(n.id, " .ptro-color-btn[data-id='")
                      .concat(t.target, "']")
                  ).style["background-color"] = t.alphaColor);
                var e = (0, s.HexToRGB)(t.palleteColor);
                void 0 !== e &&
                  ((t.palleteColor = (0, s.rgbToHex)(e.r, e.g, e.b)),
                  "line" === t.target
                    ? ((0, c.setParam)("activeColor", t.palleteColor),
                      (0, c.setParam)("activeColorAlpha", t.alpha))
                    : "fill" === t.target
                    ? ((0, c.setParam)("activeFillColor", t.palleteColor),
                      (0, c.setParam)("activeFillColorAlpha", t.alpha))
                    : "bg" === t.target
                    ? ((0, c.setParam)("backgroundFillColor", t.palleteColor),
                      (0, c.setParam)("backgroundFillColorAlpha", t.alpha))
                    : "stroke" === t.target &&
                      ((0, c.setParam)("textStrokeColor", t.palleteColor),
                      (0, c.setParam)("textStrokeColorAlpha", t.alpha)));
              })),
              ...
              (this.imageSaver = {
                asDataURL: function (t, e) {
                  ...
                  return (
                    void 0 === r &&
                      (r = n.loadedImageType ? n.loadedImageType : "image/png"),
                    n.getAsUri(r, e)
                  );
                },
                asBlob: function (t, e) {
                ...
                suggestedFileName: function (t) {
                  ...
                  return (
                    ...
                    ""
                      .concat(
                        n.loadedName || "image-".concat((0, l.genId)()),
                        "."
                      )
                      .concat(e)
                  );
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n = e;
                  return (
                    void 0 === n && (n = 0.92), this.canvas.toDataURL(t, n)
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.saving = !0;
                  var e = this.baseEl.querySelector(
                      "#".concat(this.toolByName.save.buttonId)
                    ),
                    n = this.baseEl.querySelector(
                      "#".concat(this.toolByName.save.buttonId, " > i")
                    );
                  return (
                    this.toolByName.save.buttonId &&
                      e &&
                    ...
                    n &&
                      (n.className =
                        "ptro-icon ptro-icon-loading ptro-spinning"),
                    void 0 !== this.params.saveHandler
                      ? this.params.saveHandler(this.imageSaver, function (e) {
                          !0 === e && t.hide(),
                            n && (n.className = "ptro-icon ptro-icon-save"),
                            (t.saving = !1);
                        })
                      : ((0, l.logError)(
                          "No saveHandler defined, please check documentation"
                        ),
                        n && (n.className = "ptro-icon ptro-icon-save"),
                        (this.saving = !1)),
                    this
              ...
              },
              {
                ...
                value: function (t) {
                  if (void 0 !== this.activeTool) {
                    void 0 !== this.activeTool.close && this.activeTool.close(),
                      (this.toolControls.innerHTML = "");
                    var e = this.getBtnEl(this.activeTool);
                    e &&
                      (e.className = this.getBtnEl(
                        this.activeTool
                      ).className.replace(" ptro-color-active-control", "")),
                      (this.activeTool = void 0);
                  }
                  ...
                  if (t.keyCode === l.KEYS.c && (t.ctrlKey || t.metaKey))
                    if (
                      ...
                      (a.width = o),
                        ...
                        a
                          .getContext("2d")
                          .drawImage(this.canvas, -r.topl[0], -r.topl[1]),
                        a.toBlob(
                          function (t) {
                            navigator.clipboard.write([
                              new ClipboardItem(w({}, n, t)),
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  this.size.w > this.wrapper.documentClientWidth &&
                    ...
                    !this.zoom && this.zoomFactor > a && (this.zoomFactor = a),
                    (this.zoomFactor += 0.2 * Math.sign(i)),
                    this.zoomFactor < a
                      ? ((this.zoom = !1), (this.zoomFactor = a))
                      : (this.zoom = !0),
                    this.adjustSizeFull(),
                    ...
                    this.zoom &&
                      ((this.scroller.scrollLeft =
                        ...
                        (r - this.wrapper.documentOffsetLeft)),
                      (this.scroller.scrollTop =
                        this.curCord[1] / this.getScale() -
                        (o - this.wrapper.documentOffsetTop)));
                },
              },
              {
                ...
                value: function () {
                  ...
                  (this.documentHandlers = {
                    mousedown: function (e) {
                      t.shown &&
                        (!t.worklog.empty ||
                          (-1 === e.target.className.indexOf("ptro-crp-el") &&
                            -1 === e.target.className.indexOf("ptro-icon") &&
                            -1 ===
                              e.target.className.indexOf("ptro-named-btn")) ||
                          t.clearBackground(),
                        !0 !== t.colorPicker.handleMouseDown(e) &&
                          t.handleToolEvent("handleMouseDown", e));
                    },
                    ...
                    touchmove: function (e) {
                      if (1 === e.touches.length)
                        ...
                        (n > t.lastFingerDist || n < t.lastFingerDist) &&
                          t.documentHandlers.wheel(e, 1, !0),
                          (t.lastFingerDist = n),
                          e.stopPropagation(),
                          t.zoomButtonActive || e.preventDefault();
                      }
                    },
                    mousemove: function (e) {
                      if (t.shown) {
                        t.handleToolEvent("handleMouseMove", e),
                          ...
                          (t.curCord = [
                            e.clientX - t.elLeft() + t.scroller.scrollLeft,
                            e.clientY - t.elTop() + t.scroller.scrollTop,
                          ]);
                        var n = t.getScale();
                        (t.curCord = [t.curCord[0] * n, t.curCord[1] * n]),
                    ...
                    mouseup: function (e) {
                      t.shown &&
                        (t.handleToolEvent("handleMouseUp", e),
                        t.colorPicker.handleMouseUp(e));
                    },
                    wheel: function (e, n, r) {
                      t.shown &&
                        (void 0 !== r ? r : e.ctrlKey) &&
                        (t.zoomImage(e, n), e.preventDefault());
                    },
                    keydown: function (e) {
                      console.log(
                      ...
                      var n = event.target;
                      if (
                        !["input", "textarea", "div[contenteditable]"].some(
                          function (t) {
                            return n.matches(t);
                          }
                        ) &&
                        ...
                        (r.keyCode === l.KEYS.y && r.ctrlKey) ||
                        (r.keyCode === l.KEYS.z && r.ctrlKey && r.shiftKey)
                          ? (t.worklog.redoState(),
                            e.preventDefault(),
                            t.params.userRedo && t.params.userRedo.call())
                          : r.keyCode === l.KEYS.z &&
                            r.ctrlKey &&
                            (t.worklog.undoState(),
                            e.preventDefault(),
                            t.params.userUndo && t.params.userUndo.call()),
                          t.toolByKeyCode[event.keyCode] &&
                            (t.getBtnEl(t.toolByKeyCode[event.keyCode]).click(),
                            e.stopPropagation(),
                            e.preventDefault()),
                          t.saveBtn &&
                            r.keyCode === l.KEYS.s &&
                            r.ctrlKey &&
                            (t.initText && t.wrapper.click(),
                            t.save(),
                            r.preventDefault());
                      }
                    },
                    ...
                    dragover: function (e) {
                      if (t.shown) {
                        ...
                        ("ptro-crp-el" !== n && "ptro-bar" !== n) ||
                          (t.bar.className =
                            "ptro-bar ptro-color-main ptro-bar-dragover"),
                          e.preventDefault();
                      }
                    },
                    dragleave: function () {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.toolContainer.documentOffsetLeft +
                    this.scroller.scrollLeft
                  );
                },
              },
              {
                ...
                value: function () {
                  return (
                    this.toolContainer.documentOffsetTop +
                    this.scroller.scrollTop
                  );
                },
              },
              {
                key: "fitImage",
                value: function (t, e) {
                  (this.loadedImageType = e),
                    this.resize(t.naturalWidth, t.naturalHeight),
                    this.ctx.drawImage(t, 0, 0),
                    (this.zoomFactor =
                      this.wrapper.documentClientHeight / this.size.h - 0.2),
                    this.adjustSizeFull(),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    void 0 !== this.params.onHide && this.params.onHide(),
                    this
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  if (r) {
                    ...
                    (this.resizer.newW = Math.round(this.size.w * r)),
                      (this.resizer.newH = Math.round(this.size.h * r));
                  } else {
                    if (r)
                      throw new Error(
                        "You can't pass width or height and scale at the same time"
                    ...
                    (this.resizer.newW =
                      e || Math.round(this.size.w * (n / this.size.h))),
                      (this.resizer.newH =
                        n || Math.round(this.size.h * (e / this.size.w)));
                  }
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.canvas.getAttribute("width") / this.canvas.offsetWidth
                  );
                },
              },
              {
                ...
                value: function () {
                  var t =
                    this.wrapper.documentClientWidth /
                  ...
                  if (!1 === this.zoom)
                    ...
                    (this.scroller.style.overflow = "scroll"),
                      (this.canvas.style.width = "".concat(
                        this.size.w * this.zoomFactor,
                        "px"
                      )),
                      (this.canvas.style.height = "".concat(
                        this.size.h * this.zoomFactor,
                        "px"
                      )),
                      (this.ratioRelation = 0);
              ...
              },
              {
                ...
                value: function (t, e) {
                  (this.info.innerHTML = ""
                    .concat(t, "<span>x</span>")
                    .concat(e, "<br>")
                    .concat(
                      (this.originalMime || "png").replace("image/", "")
                    )),
                    (this.size = {
                      w: t,
                      h: e,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.toolContainer.style.left = "".concat(e, "px")),
                    (this.toolContainer.style.width = "".concat(t, "px")),
                    (this.toolContainer.style.top = "".concat(r, "px")),
                    (this.toolContainer.style.height = "".concat(n, "px")),
                    (this.substrate.style.left = "".concat(e, "px")),
                    (this.substrate.style.width = "".concat(t, "px")),
                    (this.substrate.style.top = "".concat(r, "px")),
                    (this.substrate.style.height = "".concat(n, "px"));
                },
              },
              {
                key: "clear",
                value: function () {
                  var t = this,
                    e =
                      "fill" === this.params.defaultSize.width
                        ? this.wrapper.clientWidth
                        : this.params.defaultSize.width,
                    n =
                      "fill" === this.params.defaultSize.height
                        ? this.wrapper.clientHeight
                  ...
                  if (
                    ...
                    this.adjustSizeFull(),
                    this.params.initText && this.worklog.empty)
                  ) {
                    ...
                    r.length > 0 &&
                      ...
                      (this.initText.innerHTML =
                        ...
                        "".concat(this.params.initText, "</div>")),
                ...
                value: function (t) {
                  ...
                  (t.controls || []).forEach(function (t) {
                    if (
                      ((t.id = (0, l.genId)()),
                      t.title &&
                        (r += '<span class="ptro-tool-ctl-name" title="'
                          .concat((0, p.tr)(t.titleFull), '">')
                          .concat((0, p.tr)(t.title), "</span>")),
                      "btn" === t.type)
                    )
                      r +=
                        '<button type="button" '
                          .concat(
                            t.hint
                              ? 'title="'.concat((0, p.tr)(t.hint), '"')
                              : "",
                            ' class="ptro-color-control '
                          )
                          .concat(
                            t.icon ? "ptro-icon-btn" : "ptro-named-btn",
                            '" '
                          ) +
                        "id="
                          .concat(t.id, ">")
                      ...
                      r +=
                        ...
                        'style="background-color: '.concat(
                          e.colorWidgetState[t.target].alphaColor,
                          '" '
                        ) +
                        'class="color-diwget-btn ptro-color-btn ptro-bordered-btn ptro-color-control"></button><span class="ptro-btn-color-checkers-bar"></span>';
                    else if ("int" === t.type)
                      r +=
                        "<input id="
                          .concat(
                            t.id,
                            ' class="ptro-input" type="number" min="'
                          )
                          .concat(t.min, '" max="')
                          .concat(t.max, '" ') +
                        "data-id='".concat(t.target, "'/>");
                    else if ("bool" === t.type)
                      r +=
                        "<button id=".concat(
                          t.id,
                          ' class="ptro-input ptro-check" data-value="false" type="button" '
                        ) + "data-id='".concat(t.target, "'></button>");
                      ...
                      t.getAvailableValues().forEach(function (t) {
                        n +=
                          "<option ".concat(
                            t.extraStyle
                              ? "style='".concat(t.extraStyle, "'")
                              : ""
                          ) +
                          " value='"
                            .concat(t.value, "' ")
                            .concat(
                              t.title ? "title='".concat(t.title, "'") : "",
                              ">"
                            )
                            .concat(t.name, "</option>");
                      }),
                        (r +=
                          "<select id=".concat(t.id, ' class="ptro-input" ') +
                          "data-id='"
                            .concat(t.target, "'>")
                            .concat(n, "</select>"));
                    }
                  }),
                    (this.toolControls.innerHTML = r),
                    (t.controls || []).forEach(function (t) {
                      "int" === t.type
                        ? ((e.getElemByIdSafe(t.id).value = t.getValue()),
                          (e.getElemByIdSafe(t.id).oninput = t.action))
                        : "bool" === t.type
                        ? (e
                            .getElemByIdSafe(t.id)
                            .setAttribute(
                              "data-value",
                              t.getValue() ? "true" : "false"
                            ),
                          (e.getElemByIdSafe(t.id).onclick = t.action))
                        : "dropdown" === t.type
                        ? ((e.getElemByIdSafe(t.id).onchange = t.action),
                          (e.getElemByIdSafe(t.id).value = t.getValue()))
                        : (e.getElemByIdSafe(t.id).onclick = t.action);
                    }),
                    t.activate();
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "paintAt",
                value: function (t, e) {
                  (t = (t = Math.round(t)) > 0 ? t : 0),
                    (e = (e = Math.round(e - 1)) > 0 ? e : 0),
                    this.getClickedOnColor(t, e);
                  var n = 4 * (e * this.canvasWidth + t),
                    ...
                    A =
                      (r.a,
                      (0, o.HexToRGB)(
                        this.main.colorWidgetState.fill.palleteColor
                      ));
                  (this.color = this.main.colorWidgetState.fill.palleteColor),
                    (i === A.r && a === A.g && l === A.b) ||
                      (this.floodFill(t, e, i, a, l),
                ...
                value: function (t, e, n, r, i) {
                  for (
                    var a,
                      ...
                      h = this.drawingAreaX,
                      u = this.drawingAreaY,
                      d = this.drawingAreaX + this.drawingAreaWidth - 1,
                      f = this.drawingAreaY + this.drawingAreaHeight - 1,
                      g = [[t, e]];
                    g.length;

                  ) {
                    (l = (a = g.pop())[0]),
                      (s = 4 * ((A = a[1]) * this.canvasWidth + l));
                    for (
                      var m = (0, o.HexToRGB)(this.color);
                      A >= u && this.matchStartColor(s);

                    )
                      (A -= 1), (s -= 4 * this.canvasWidth);
                    for (
                      s += 4 * this.canvasWidth, A += 1, c = !1, p = !1;
                      A <= f && this.matchStartColor(s);

                    )
                      (A += 1),
                        this.colorPixel(s, m.r, m.g, m.b),
                        l > h &&
                          (this.matchStartColor(s - 4)
                            ? c || (g.push([l - 1, A]), (c = !0))
                            : c && (c = !1)),
                        l < d &&
                          (this.matchStartColor(s + 4)
              ...
              },
              {
                key: "colorPixel",
                value: function (t, e, n, r, o) {
                  (this.colorLayerData.data[t] = e),
                    (this.colorLayerData.data[t + 1] = n),
                    (this.colorLayerData.data[t + 2] = r),
                    (this.colorLayerData.data[t + 3] = void 0 !== o ? o : 255);
                },
              },
              {
                key: "getPixelColor",
      ...
      927: function (t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", {
          ...
          (e.setDefaults = function (t, e) {
            ...
            (n.NON_SELECTABLE_TOOLS = ["pixelize", "crop", "rotate"]),
              (n.activeColor = s.activeColor || n.activeColor || "#ff0000"),
              (n.activeColorAlpha = c(
                s.activeColorAlpha,
                n.activeColorAlpha,
                1
              )),
              (n.activeAlphaColor = (0, r.HexToRGBA)(
                n.activeColor,
                n.activeColorAlpha
              )),
              (n.activeFillColor =
                s.activeFillColor || n.activeFillColor || "#000000"),
              (n.activeFillColorAlpha = c(
                s.activeFillColorAlpha,
                n.activeFillColorAlpha,
                0
              )),
              (n.activeFillAlphaColor = (0, r.HexToRGBA)(
                n.activeFillColor,
                n.activeFillColorAlpha
              )),
              (n.replace_all_on_empty_background = n.initText =
                n.initText || null),
              (n.initTextColor = n.initTextColor || "#808080"),
              (n.initTextStyle =
                n.initTextStyle || "26px 'Open Sans', sans-serif"),
              (n.defaultLineWidth =
                s.defaultLineWidth || n.defaultLineWidth || 5),
              (n.defaultPrimitiveShadowOn = c(
                s.defaultPrimitiveShadowOn,
                n.defaultPrimitiveShadowOn,
                !0
              )),
              (n.defaultArrowLength =
                s.defaultArrowLength || n.defaultArrowLength || 32),
              (n.defaultEraserWidth = c(
                s.defaultEraserWidth,
                n.defaultEraserWidth,
                5
              )),
              (n.defaultFontSize = c(s.defaultFontSize, n.defaultFontSize, 24)),
              (n.defaultFontBold = c(s.defaultFontBold, n.defaultFontBold, !1)),
              (n.defaultFontItalic = c(
                s.defaultFontItalic,
                n.defaultFontItalic,
                !1
              )),
              (n.replaceAllOnEmptyBackground = c(
                n.replaceAllOnEmptyBackground,
                !0
              )),
              (n.backgroundFillColor =
                s.backgroundFillColor || n.backgroundFillColor || "#ffffff"),
              (n.backgroundFillColorAlpha = n.backplateImgUrl
                ? 0
                : c(s.backgroundFillColorAlpha, n.backgroundFillColorAlpha, 1)),
              (n.backgroundFillAlphaColor = (0, r.HexToRGBA)(
                n.backgroundFillColor,
                n.backgroundFillColorAlpha
              )),
              (n.textStrokeColor =
                s.textStrokeColor || n.textStrokeColor || "#ffffff"),
              (n.textStrokeColorAlpha = c(
                s.textStrokeColorAlpha,
                n.textStrokeColorAlpha,
                1
              )),
              (n.textStrokeAlphaColor = (0, r.HexToRGBA)(
                n.textStrokeColor,
                n.textStrokeColorAlpha
              )),
              (n.shadowScale = c(n.shadowScale, 1)),
              (n.defaultTextStrokeAndShadow = c(
                s.defaultTextStrokeAndShadow,
                n.defaultTextStrokeAndShadow,
                !0
              )),
              (n.worklogLimit = c(n.worklogLimit, 100)),
              (n.hiddenTools = n.hiddenTools || ["redo", "zoomin", "zoomout"]),
              n.hiddenTools.forEach(function (t) {
                e.includes(t) ||
                  (0, o.logError)("Hidden tool with name ".concat(t));
              }),
              n.defaultTool
                ? n.hiddenTools.includes(n.defaultTool) &&
                  ((0, o.logError)(
                    "Can't hide default tool '".concat(
                      n.defaultTool,
                      "', please change default tool to another to hide it"
                    )
                  ),
                  n.hiddenTools.splice(defaultInHiddenIndex, 1))
                : (n.defaultTool = e.filter(function (t) {
                    return (
                      !n.hiddenTools.includes(t) &&
                      !n.NON_SELECTABLE_TOOLS.includes(t)
                    );
                  })[0]);
            if (
              ((n.pixelizePixelSize =
                s.pixelizePixelSize || n.pixelizePixelSize || "20%"),
              (n.colorScheme = n.colorScheme || {}),
              (n.colorScheme.main = n.colorScheme.main || "#fff"),
              (n.colorScheme.control = n.colorScheme.control || "#fff"),
              (n.colorScheme.controlShadow =
                n.colorScheme.controlShadow || "0px 0px 3px 1px #bbb"),
              (n.colorScheme.controlContent =
                n.colorScheme.controlContent || "#000000"),
              (n.colorScheme.hoverControl =
                n.colorScheme.hoverControl || n.colorScheme.control),
              (n.colorScheme.hoverControlContent =
                n.colorScheme.hoverControlContent || "#1a3d67"),
              (n.colorScheme.toolControlNameColor =
                n.colorScheme.toolControlNameColor || "rgba(0,0,0,0.07)"),
              (n.colorScheme.activeControl =
                n.colorScheme.activeControl || "#7485B1"),
              (n.colorScheme.activeControlContent =
                n.colorScheme.activeControlContent || n.colorScheme.main),
              (n.colorScheme.inputBorderColor =
                n.colorScheme.inputBorderColor || n.colorScheme.main),
              (n.colorScheme.inputBackground =
                n.colorScheme.inputBackground || "#ffffff"),
              (n.colorScheme.inputShadow =
                n.colorScheme.inputShadow || "inset 0 0 4px 1px #ccc"),
              (n.colorScheme.inputText =
                n.colorScheme.inputText || n.colorScheme.activeControl),
              (n.colorScheme.backgroundColor =
                n.colorScheme.backgroundColor || "#999999"),
              (n.colorScheme.dragOverBarColor =
                n.colorScheme.dragOverBarColor || "#899dff"),
              (n.defaultSize = n.defaultSize || "fill"),
              (n.defaultPixelSize = n.defaultPixelSize || 4),
              (n.extraFonts = n.extraFonts || []),
              (n.toolbarHeightPx = n.toolbarHeightPx || 40),
              (n.buttonSizePx = n.buttonSizePx || 32),
              (n.bucketSensivity = n.bucketSensivity || 100),
              "object" !== l(n.defaultSize))
            )
              if ("fill" === n.defaultSize)
                n.defaultSize = {
                  width: "fill",
                  height: "fill",
                };
            ...
            if (
              ((n.toolbarPosition = n.toolbarPosition || "bottom"),
              (n.fixMobilePageReloader =
                void 0 === n.fixMobilePageReloader || n.fixMobilePageReloader),
              n.translation)
            ) {
              var p = n.translation.name;
              i.default.get().addTranslation(p, n.translation.strings),
                i.default.get().activate(p);
            }
            return (
              (n.styles = ".ptro-color-main{\n      background-color:"
                .concat(n.colorScheme.main, ";\n      color:")
                .concat(
                  n.colorScheme.controlContent,
                  ";\n    }\n    .ptro-color-control{\n      box-shadow:"
                )
                ...
                .concat(n.colorScheme.hoverControl, ";\n        color:")
                .concat(
                  n.colorScheme.hoverControlContent,
                  "}    \n    .ptro-bordered-control{border-color: "
                )
                .concat(
                  n.colorScheme.activeControl,
                ...
                .concat(n.colorScheme.inputBackground, ";\n      color: ")
                .concat(n.colorScheme.inputText, ";\n      box-shadow:")
                .concat(
                  n.colorScheme.inputShadow,
                  ";\n    }\n    .ptro-bar-dragover{background-color:"
                )
                .concat(
                  n.colorScheme.dragOverBarColor,
                ...
                .concat(n.colorScheme.activeControl, ";\n        color: ")
                .concat(
                  n.colorScheme.activeControlContent,
                ...
                .concat(n.colorScheme.backgroundColor, ";\n      bottom:")
                .concat(
                  "top" === n.toolbarPosition ? "0" : n.toolbarHeightPx,
                  "px;\n      top:"
                )
                .concat(
                  "top" === n.toolbarPosition ? n.toolbarHeightPx : "0",
                  "px;\n    }\n    .ptro-icon-btn {\n      height: "
                )
                .concat(n.buttonSizePx, "px;\n      width: ")
                .concat(n.buttonSizePx, "px;\n      margin: 0 0 0 ")
                .concat(
                  (n.toolbarHeightPx - n.buttonSizePx) / 2,
                  "px;\n    }\n    .ptro-bar-right {\n      margin-right: "
                )
                .concat(
                  (n.toolbarHeightPx - n.buttonSizePx) / 2,
                ...
                .concat(n.toolbarHeightPx, "px;\n      ")
                .concat(
                  "top" === n.toolbarPosition ? "top" : "bottom",
                  ": 0;\n    }"
                )),
              n
            );
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                ...
                value: function (t) {
                  if (!"".concat(t).match(/^\d+$/))
                    throw Error('WARN: STR "'.concat(t, '" is not an int'));
                  this.lineWidth = +t;
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  (this.ctx.lineWidth = this.lineWidth),
                    (this.ctx.strokeStyle =
                      this.main.colorWidgetState.line.alphaColor),
                    (this.ctx.fillStyle =
                      this.main.colorWidgetState.fill.alphaColor);
                  ...
                  if (
                    ...
                    if (
                      ((this.tmpData = this.ctx.getImageData(
                        0,
                        0,
                        this.main.size.w,
                        this.main.size.h
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (
                    var i = 1 !== this.main.currentBackgroundAlpha, a = 1;
                    a <= (o && i ? 2 : 1);
                    a += 1
                  )
                    if (
                      (o &&
                        ((this.ctx.globalCompositeOperation =
                          1 === a && i ? "destination-out" : r),
                        (t =
                          1 === a && i
                            ? "rgba(0,0,0,1)"
                            : this.main.currentBackground)),
                      1 === n.length)
                    )
                      this.ctx.beginPath(),
                  ...
                  if (this.state.cornerMarked) {
                    ...
                    if (
                      ...
                      if (t.ctrlKey || t.shiftKey) {
                        ...
                        if (Math.abs(o) < 22.5)
                          this.curCord[1] = this.centerCord[1];
                        else if (Math.abs(o) > 67.5)
                          this.curCord[0] = this.centerCord[0];
                        else {
                          var i =
                            (Math.abs(this.curCord[0] - this.centerCord[0]) -
                              Math.abs(this.centerCord[1] - this.curCord[1])) /
                            2;
                          (this.curCord[0] -=
                            i *
                            (this.centerCord[0] < this.curCord[0] ? 1 : -1)),
                            (this.curCord[1] -=
                              i *
                              (this.centerCord[1] > this.curCord[1] ? 1 : -1));
                        }
                      }
                      e.beginPath(),
                        e.moveTo(this.centerCord[0], this.centerCord[1]),
                        e.lineTo(this.curCord[0], this.curCord[1]),
                        e.closePath();
                      var a = e.shadowColor;
                      this.shadowOn &&
                        ((e.shadowColor = "rgba(0,0,0,0.7)"),
                        (e.shadowBlur = this.lineWidth),
                        (e.shadowOffsetX = this.lineWidth / 2),
                        (e.shadowOffsetY = this.lineWidth / 2)),
                        e.stroke(),
                        (e.shadowColor = a);
                      ...
                      this.curCord[0] < this.centerCord[0] && (l = 180 + l),
                        this.ctx.beginPath();
                      ...
                      var p,
                        ...
                        d = Math.min(
                          ...
                          0.9 *
                            Math.sqrt(
                              Math.pow(
                                this.centerCord[0] - this.curCord[0],
                                2
                              ) +
                                Math.pow(
                                  this.centerCord[1] - this.curCord[1],
                                  2
                                )
                            )
                        ),
                      ...
                      var w = B + (h - B) / 3,
                        b = v + (u - v) / 3;
                      e.lineTo(w, b),
                        e.lineTo(this.centerCord[0], this.centerCord[1]),
                        (p += (1 / 3) * (2 * Math.PI));
                      ...
                      this.shadowOn &&
                        ((e.shadowColor = "rgba(0,0,0,0.7)"),
                        (e.shadowBlur =
                          Math.log(d) * this.main.params.shadowScale),
                        (e.shadowOffsetX = Math.log10(d)),
                        (e.shadowOffsetY = Math.log10(d))),
                        e.fill(),
                        (e.lineCap = s),
                        (e.fillStyle = c),
                        (e.shadowColor = I);
                      ...
                      this.shadowOn &&
                        ...
                        (e.shadowOffsetX = this.lineWidth / 2),
                        (e.shadowOffsetY = this.lineWidth / 2)),
                        this.lineWidth && this.ctx.strokeRect(k[0], k[1], S, E),
                        (e.shadowColor = Q),
                        this.ctx.closePath();
                      ...
                      var R,
                        ...
                        G = L / 2,
                        U = D / 2;
                      L > D ? ((N = L / D), (R = G)) : ((H = D / L), (R = U)),
                        this.ctx.scale(1 / H, 1 / N),
                        this.ctx.arc(
                          (O + G) * H,
                          (j + U) * N,
                          R,
              ...
              },
              {
                key: "handleMouseUp",
                value: function () {
                  this.state.cornerMarked &&
                    ((this.state.cornerMarked = !1),
                    this.main.worklog.captureState());
                },
              },
              {
        ...
        var a = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.inputW = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper .ptro-resize-width-input"
              )),
              (this.inputH = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper .ptro-resize-heigth-input"
              )),
              (this.inputWLimit = 1e4),
              (this.inputHLimit = 13e3),
              (this.linkButton = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper button.ptro-link"
              )),
              (this.linkButtonIcon = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper button.ptro-link i"
              )),
              (this.closeButton = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper button.ptro-close"
              )),
              (this.scaleButton = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper button.ptro-scale"
              )),
              (this.resizeButton = e.wrapper.querySelector(
                ".ptro-resize-widget-wrapper button.ptro-resize"
              )),
              (this.linked = !0),
              (this.closeButton.onclick = function () {
                n.startClose();
              ...
              (this.scaleButton.onclick = function () {
                if (t.validationZeroValue(n.newH, n.newW)) {
                  ...
                  n.main.resize(n.newW, n.newH),
                    n.main.ctx.save(),
                    n.main.ctx.scale(n.newW / e, n.newH / r);
                  var i = new Image();
                  (i.onload = function () {
                    n.main.ctx.drawImage(i, 0, 0),
                      n.main.adjustSizeFull(),
                      n.main.ctx.restore(),
                      n.main.worklog.captureState(),
                      n.startClose();
                  }),
                    (i.src = o);
                }
              ...
              (this.linkButton.onclick = function () {
                (n.linked = !n.linked),
                  n.linked
                    ? (n.linkButtonIcon.className =
                        "ptro-icon ptro-icon-linked")
                    : (n.linkButtonIcon.className =
                        "ptro-icon ptro-icon-unlinked");
              }),
              (this.inputW.oninput = function () {
                var t = Number(n.inputW.value);
                if ((n.validationWidth(t), n.linked)) {
                  var e = n.main.size.ratio;
                  (n.newH = Math.round(n.newW / e)),
                    n.validationHeight(n.newH),
                    (n.inputH.value = n.newH);
                }
              }),
              (this.inputH.oninput = function () {
                ...
                if ((n.validationHeight(t), n.linked)) {
                  var e = n.main.size.ratio;
                  (n.newW = Math.round(n.newH * e)),
                    n.validationWidth(n.newW),
                    (n.inputW.value = +n.newW);
                }
              });
          }
          var e, n, a;
          return (
            ...
            (a = [
              ...
              },
              {
                ...
                value: function () {
                  return (
                    '<div class="ptro-resize-widget-wrapper ptro-common-widget-wrapper ptro-v-middle" hidden><div class="ptro-resize-widget ptro-color-main ptro-v-middle-in"><div style="display: inline-block"><table><tr>' +
                    '<td class="ptro-label ptro-resize-table-left">'.concat(
                      (0, r.tr)("width"),
                      "</td>"
                    ) +
                    '<td><input class="ptro-input ptro-resize-width-input" type="number" min="0" max="3000" step="1"/></td></tr><tr>' +
                    '<td class="ptro-label ptro-resize-table-left">'.concat(
                      (0, r.tr)("height"),
                      "</td>"
                    ) +
                    '<td><input class="ptro-input ptro-resize-heigth-input" type="number" min="0" max="3000" step="1"/></td></tr></table></div><div class="ptro-resize-link-wrapper">' +
                    '<button type="button" class="ptro-icon-btn ptro-link ptro-color-control" title="'.concat(
                      (0, r.tr)("keepRatio"),
                      '">'
                    ) +
                    '<i class="ptro-icon ptro-icon-linked" style="font-size: 18px;"></i></button></div><div></div><div style="margin-top: 40px;"><button type="button" class="ptro-named-btn ptro-resize ptro-color-control">' +
                    "".concat((0, r.tr)("resizeResize"), "</button>") +
                    '<button type="button" class="ptro-named-btn ptro-scale ptro-color-control">' +
                    "".concat((0, r.tr)("resizeScale"), "</button>") +
                    '<button type="button" class="ptro-named-btn ptro-close ptro-color-control">' +
                    "".concat((0, r.tr)("cancel"), "</button>") +
                    "</div></div></div>"
                  );
                },
              },
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (e) {
                  if (!this.validationHeightValue(e))
                    return (
                      (this.inputH.value = this.inputHLimit),
                      void (this.newH = this.inputHLimit)
                    );
                  (this.newH = e),
                    t.validationEmptyValue(e)
                      ? (this.newH = e)
                      : ((this.inputH.value = 0), (this.newH = 0));
                },
              },
              {
                key: "validationWidth",
                value: function (e) {
                  if (!this.validationWidthValue(e))
                    return (
                      (this.inputW.value = this.inputWLimit),
                      void (this.newW = this.inputWLimit)
                    );
                  (this.newW = e),
                    t.validationEmptyValue(e)
                      ? (this.newW = e)
                      : ((this.inputW.value = "0"), (this.newW = 0));
                },
              },
              {
                key: "open",
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    t.keyCode === o.KEYS.enter ||
                    (t.keyCode === o.KEYS.esc && (this.startClose(), !0))
                  );
                },
              },
            ]) && i(e.prototype, n),
        ...
        var i = (function () {
          function t(e, n) {
            !(function (t, e) {
              ...
              (this.ctx = e.ctx),
              (this.areaionCallback = n),
              (this.shown = !1),
              (this.area = {
                el: e.toolContainer,
                rect: document.querySelector(
                  "#".concat(e.id, " .ptro-crp-rect")
                ),
              }),
              (this.imagePlaced = !1),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  var t = this.area.topl,
                    e = [
                      this.area.bottoml[0] - t[0],
                      this.area.bottoml[1] - t[1],
                    ];
                  if (
                    ((this.pixelizePixelSize =
                      this.main.params.pixelizePixelSize),
                    "%" === this.pixelizePixelSize.slice(-1)
                      ? (this.pixelSize =
                          Math.min(e[0], e[1]) /
                          (100 / this.pixelizePixelSize.slice(0, -1)))
                      : "px" === this.pixelizePixelSize.slice(-2).toLowerCase()
                  ...
                  for (
                    var o = [],
                      i = [e[0] / this.pixelSizeX, e[1] / this.pixelSizeY],
                      a = 0;
                    a < i[0];
                    a += 1
                  ) {
                    for (var l = [], A = 0; A < i[1]; A += 1)
                      l.push([0, 0, 0, 0, 0]);
                    o.push(l);
                  }
                  for (
                    var s = this.ctx.getImageData(t[0], t[1], e[0], e[1]),
                      c = 0;
                    c < e[0];
                    c += 1
                  )
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.canvas.clientWidth / this.canvas.getAttribute("width")
                  );
                },
              },
              {
                ...
                value: function () {
                  var t = this.getScale();
                  (this.area.topl = [
                    Math.round((this.rectLeft() - this.main.elLeft()) / t),
                    Math.round((this.rectTop() - this.main.elTop()) / t),
                  ]),
                    (this.area.bottoml = [
                      Math.round(
                        this.area.topl[0] + (this.area.rect.clientWidth + 2) / t
                      ),
                      Math.round(
                        this.area.topl[1] +
                          (this.area.rect.clientHeight + 2) / t
                      ),
                    ]);
                },
              },
                ...
                value: function () {
                  if (this.shown) {
                    ...
                    this.setLeft(this.area.topl[0] * t),
                      ...
                      this.setRight(0),
                      this.setRight(
                        this.canvas.clientWidth - this.area.bottoml[0] * t
                      ),
                      this.setBottom(
                        this.canvas.clientHeight - this.area.bottoml[1] * t
                      );
                  }
                },
              },
              {
                ...
                value: function (t, e, n, r, o) {
                  ...
                  A >= 1
                    ...
                    : ((a.width = o.naturalWidth * A),
                      (a.height = o.naturalHeight * A),
                      l.scale(A, A),
                      l.drawImage(o, 0, 0),
                      (this.placedDataLow = a.toDataURL("image/png"))),
                    (this.main.select.area.rect.style["background-image"] =
                      "url(".concat(this.placedData, ")")),
                    this.show(),
                    this.reCalcCropperCords(),
                    (this.imagePlaced = !0),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (this.shown && this.imagePlaced) {
                    if (t.keyCode === r.KEYS.enter)
                      return this.finishPlacing(), !0;
                    if (t.keyCode === r.KEYS.esc)
                      return this.cancelPlacing(), !0;
                  } else {
                    if (this.shown && t.keyCode === r.KEYS.del)
                      return this.doClearArea(), !0;
                    if (t.keyCode === r.KEYS.a && t.ctrlKey)
                      return this.selectAll(), event.preventDefault(), !0;
                    if (t.keyCode === r.KEYS.esc && this.shown)
                      return this.hide(), !0;
                  }
                  return !1;
                },
                      ...
                      "ptro-crp-el": function () {
                        if (e.area.activated) {
                          ...
                          var n =
                              t.clientX -
                              e.main.elLeft() +
                              e.main.scroller.scrollLeft,
                            r =
                              t.clientY -
                              e.main.elTop() +
                              e.main.scroller.scrollTop;
                          e.setLeft(n),
                            e.setTop(r),
                            e.setRight(e.area.el.clientWidth - n),
                            e.setBottom(e.area.el.clientHeight - r),
              ...
              },
              {
                ...
                value: function (t) {
                  (this.left = t),
                    (this.area.rect.style.left = "".concat(t, "px"));
                },
              },
              {
                key: "setRight",
                value: function (t) {
                  (this.right = t),
                    (this.area.rect.style.right = "".concat(t, "px"));
                },
              },
              {
                key: "setTop",
                value: function (t) {
                  (this.top = t),
                    (this.area.rect.style.top = "".concat(t, "px"));
                },
              },
              {
                key: "setBottom",
                value: function (t) {
                  (this.bottom = t),
                    (this.area.rect.style.bottom = "".concat(t, "px"));
                },
              },
              {
                key: "handleMouseMove",
                value: function (t) {
                  if (this.area.activated)
                    if (this.area.moving) {
                      ...
                      o < 0
                        ? (o = 0)
                        : o + this.area.rect.clientHeight >
                            this.area.el.clientHeight - 2 &&
                          (o =
                            this.area.el.clientHeight -
                            this.area.rect.clientHeight -
                            2);
                      var i = o - this.top;
                      this.setTop(o),
                        this.setBottom(this.bottom - i),
                        this.reCalcCropperCords();
                    } else {
                      var a = !1;
                      if (this.area.resizingL) {
                        a = !0;
                        var l = this.fixCropperLeft(
                          t.clientX + this.main.scroller.scrollLeft
                        );
                        this.setLeft(l - this.main.elLeft()),
                          this.reCalcCropperCords();
                      }
                      if (this.area.resizingR) {
                        a = !0;
                        var A = this.fixCropperRight(
                          t.clientX + this.main.scroller.scrollLeft
                        );
                        this.setRight(
                          this.area.el.clientWidth + this.main.elLeft() - A
                        ),
                          this.reCalcCropperCords();
                      }
                      if (this.area.resizingT) {
                        a = !0;
                        var s = this.fixCropperTop(
                          t.clientY + this.main.scroller.scrollTop
                        );
                      ...
                      if (this.area.resizingB) {
                        a = !0;
                        var c = this.fixCropperBottom(
                          t.clientY + this.main.scroller.scrollTop
                        );
                        this.setBottom(
                          this.area.el.clientHeight + this.main.elTop() - c
                        ),
                          this.reCalcCropperCords();
                      }
                      !this.imagePlaced ||
              ...
              },
              {
                ...
                value: function () {
                  var t = this.area.rect.clientHeight * this.placedRatio,
                    e =
                      this.main.elLeft() +
                      (this.area.el.clientWidth - this.right - t - 2),
              ...
              },
              {
                ...
                value: function () {
                  var t = this.area.rect.clientWidth / this.placedRatio,
                    e = this.fixCropperTop(
                      this.main.elTop() +
                        (this.area.el.clientHeight - this.bottom - t - 2)
                    );
              ...
              },
              {
                ...
                value: function () {
                  var t = this.area.rect.clientWidth / this.placedRatio,
                    e = this.fixCropperBottom(
                      this.main.elTop() + this.top + t + 2
                    );
                  this.setBottom(
                    this.area.el.clientHeight + this.main.elTop() - e
                  );
                },
              },
              {
                ...
                value: function () {
                  var t = this.area.rect.clientHeight * this.placedRatio,
                    e = this.fixCropperRight(
                      this.main.elLeft() + this.left + t + 2
                    );
                  this.setRight(
                    this.area.el.clientWidth + this.main.elLeft() - e
                  );
                },
              },
              {
                ...
                value: function () {
                  if (this.area.topl) {
                    ...
                    this.setLeft(this.area.topl[0] * t),
                      ...
                      this.setRight(
                        this.area.el.clientWidth -
                          (this.area.bottoml[0] - this.area.topl[0]) * t
                      ),
                      this.setBottom(
                        this.area.el.clientHeight -
                          (this.area.bottoml[1] - this.area.topl[1]) * t
                      );
                  }
                },
              },
              {
                ...
                value: function () {
                  return (
                    this.area.rect.documentOffsetLeft +
                    this.main.scroller.scrollLeft
                  );
                },
              },
              {
                ...
                value: function () {
                  return (
                    this.area.rect.documentOffsetTop +
                    this.main.scroller.scrollTop
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return e > n
                    ? n
                    : (e < this.rectLeft() &&
                        ((e = this.rectLeft() + this.area.rect.clientWidth),
                        this.area.resizingR &&
                          ((this.area.resizingR = !1),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return e > n
                    ? n
                    : (e < this.rectTop() &&
                        ((e = this.rectTop() + this.area.rect.clientHeight),
                        this.area.resizingB &&
                          ((this.area.resizingB = !1),
        ...
        var l = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.inputPixelSize = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper .ptro-pixel-size-input"
              )),
              (this.applyButton = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper button.ptro-apply"
              )),
              (this.closeButton = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper button.ptro-close"
              )),
              (this.clearButton = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper button.ptro-clear"
              )),
              (this.bgSelBtn = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper .ptro-color-btn"
              )),
              (this.errorHolder = e.wrapper.querySelector(
                ".ptro-settings-widget-wrapper .ptro-error"
              )),
              (this.clearButton.onclick = function () {
                (n.main.currentBackground =
                  n.main.colorWidgetState.bg.alphaColor),
                  (n.main.currentBackgroundAlpha =
                    n.main.colorWidgetState.bg.alpha),
                  n.main.clearBackground(),
                  n.startClose();
              }),
              ...
              this.applyButton &&
                (this.applyButton.onclick = function () {
                  var t,
                    e = (0, o.trim)(n.inputPixelSize.value);
                  if ("%" === e.slice(-1)) {
                    var a = (0, o.trim)(e.slice(0, -1));
                    (t = /^\d+$/.test(a) && 0 !== parseInt(a, 10)) &&
                      (e = "".concat(a, "%"));
                  } else t = /^\d+$/.test(e) && 0 !== parseInt(e, 10);
                  t
                    ? ((n.main.select.pixelizePixelSize = e),
                      (0, i.setParam)("pixelizePixelSize", e),
                      n.startClose(),
                      n.errorHolder.setAttribute("hidden", ""))
                    : ((n.errorHolder.innerText = (0, r.tr)(
                        "wrongPixelSizeValue"
                      )),
                      n.errorHolder.removeAttribute("hidden"));
                });
          }
          var e, n, l;
          return (
            ...
            (l = [
              {
                ...
                value: function (t) {
                  return (
                    '<div class="ptro-settings-widget-wrapper ptro-common-widget-wrapper ptro-v-middle" hidden><div class="ptro-settings-widget ptro-color-main ptro-v-middle-in"><table style="margin-top: 5px"><tr>' +
                    '<td class="ptro-label ptro-resize-table-left" style="height:30px;">'.concat(
                      (0, r.tr)("backgroundColor"),
                      "</td>"
                    ) +
                    '<td class="ptro-strict-cell"><button type="button" data-id="bg" class="ptro-color-btn ptro-bordered-btn ptro-color-control" style="margin-top: -12px;"></button><span class="ptro-btn-color-checkers"></span></td><td>' +
                    '<button type="button" style="margin-top: -2px;" class="ptro-named-btn ptro-clear ptro-color-control" title="'
                      .concat((0, r.tr)("fillPageWith"), '">')
                      .concat((0, r.tr)("clear"), "</button>") +
                    "</td></tr>" +
                    (t.params.pixelizeHideUserInput
                      ? ""
                      : "<tr>" +
                        '<td class="ptro-label ptro-resize-table-left" >'.concat(
                          (0, r.tr)("pixelizePixelSize"),
                          "</td>"
                        ) +
                        '<td colspan="2"><input class="ptro-input ptro-pixel-size-input" pattern="[0-9]{1,}%?" type="text" /></td></tr>') +
                    '</table><div class="ptro-error" hidden></div><div style="margin-top: 20px">' +
                    (t.params.pixelizeHideUserInput
                      ? '<button type="button" class="ptro-named-btn ptro-close ptro-color-control">'.concat(
                          (0, r.tr)("close"),
                          "</button>"
                        )
                      : '<button type="button" class="ptro-named-btn ptro-apply ptro-color-control">' +
                        "".concat((0, r.tr)("apply"), "</button>") +
                        '<button type="button" class="ptro-named-btn ptro-close ptro-color-control">'.concat(
                          (0, r.tr)("cancel"),
                          "</button>"
                        )) +
              ...
              },
              {
                ...
                value: function () {
                  this.wrapper.removeAttribute("hidden"),
                    (this.opened = !0),
                    this.inputPixelSize &&
                      (this.inputPixelSize.value =
                        this.main.select.pixelizePixelSize),
                    (this.bgSelBtn.style["background-color"] =
                      this.main.colorWidgetState.bg.alphaColor);
                },
              },
              {
                key: "close",
        ...
        var c = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.wrapper = e.wrapper),
              (this.input = this.el.querySelector(".ptro-text-tool-input")),
              (this.inputWrapper = this.el.querySelector(
                ".ptro-text-tool-input-wrapper"
              )),
              (this.inputWrapper.style.display = "none"),
              (this.isBold = e.params.defaultFontBold),
              (this.isItalic = e.params.defaultFontItalic),
              (this.strokeOn = e.params.defaultTextStrokeAndShadow),
              (this.strokeColor = e.params.textStrokeAlphaColor),
          ...
          return (
            ...
            (r = [
              {
                ...
                value: function () {
                  return (
                    '<span class="ptro-text-tool-input-wrapper"><div contenteditable="true" class="ptro-text-tool-input"></div><span class="ptro-text-tool-buttons">' +
                    '<button type="button" class="ptro-text-tool-apply ptro-icon-btn ptro-color-control" title="'.concat(
                      (0, i.tr)("apply"),
                      '" \n                   style="margin: 2px">'
                    ) +
                    '<i class="ptro-icon ptro-icon-apply"></i></button>' +
                    '<button type="button" class="ptro-text-tool-cancel ptro-icon-btn ptro-color-control" title="'.concat(
                      (0, i.tr)("cancel"),
                      '"\n                   style="margin: 2px">'
                    ) +
                    '<i class="ptro-icon ptro-icon-close"></i></button></span></span>'
                  );
                },
              },
            ]),
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  var t = [
                    ...
                    ].concat(l(this.main.params.extraFonts)),
                    e = [];
                  return (
              ...
              },
              {
                ...
                value: function (t) {
                  (this.isBold = t),
                    ...
                    this.active && (this.input.focus(), this.reLimit()),
              ...
              },
              {
                ...
                value: function (t) {
                  (this.isItalic = t),
                    (this.input.style["font-style"] = t ? "italic" : "normal"),
                    this.active && (this.input.focus(), this.reLimit());
                },
              },
              {
                ...
                value: function (t) {
                  (this.fontSize = t),
                    (this.input.style["font-size"] = "".concat(t, "px")),
                    this.setStrokeParams(),
                    this.active && this.reLimit();
                },
              },
                ...
                value: function () {
                  this.strokeOn
                    ? (this.input.style["text-shadow"] = "\n      -"
                        ...
                        .concat(1, "px ")
                        .concat(
                          Math.log(this.fontSize) *
                            this.main.params.shadowScale,
                          "px black"
                        ))
              ...
              },
              {
                ...
                value: function (t) {
                  (this.color = t),
                    ...
                    (this.input.style["outline-color"] = t);
                },
              },
              {
                key: "inputLeft",
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.input.documentOffsetTop + this.main.scroller.scrollTop
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if ("ptro-crp-el" === t.target.classList[0]) {
                    ...
                    var n = this.main.getScale();
                    (this.scaledCord = [this.crd[0] * n, this.crd[1] * n]),
                      (this.inputWrapper.style.left = "".concat(
                        this.crd[0],
                        "px"
                      )),
                      (this.inputWrapper.style.top = "".concat(
                        this.crd[1],
                        "px"
                      )),
                      ...
                      (this.input.onkeydown = function (t) {
                        t.ctrlKey &&
                          t.keyCode === o.KEYS.enter &&
                          (e.apply(), t.preventDefault()),
                          t.keyCode === o.KEYS.esc &&
                            (e.close(),
                            e.main.closeActiveTool(),
                            t.preventDefault()),
                          e.reLimit(),
                          e.pendingClear &&
                            ((e.input.innerText = e.input.innerText.slice(1)),
                            (e.pendingClear = !1)),
                          t.stopPropagation();
                      }),
                        ...
                        (r.src = n),
                          (r.onload = function () {
                            t.ctx.drawImage(
                              ...
                              (t.input.style.border = e),
                              t.close(),
                              t.main.worklog.captureState(),
                              t.main.closeActiveTool();
                          });
                      })
                      .catch(function (t) {
      ...
      564: function (t, e) {
        ...
        Object.defineProperty(e, "__esModule", {
          ...
          (e.addDocumentObjectHelpers = function () {
            "documentOffsetTop" in Element.prototype ||
              Object.defineProperty(Element.prototype, "documentOffsetTop", {
                get: function () {
                  return this.getBoundingClientRect().top;
                },
              });
            "documentOffsetLeft" in Element.prototype ||
              Object.defineProperty(Element.prototype, "documentOffsetLeft", {
                get: function () {
                  return this.getBoundingClientRect().left;
                },
              });
            "documentClientWidth" in Element.prototype ||
            ...
            "documentClientHeight" in Element.prototype ||
          ...
          (e.clearSelection = function () {
            ...
            window.getSelection
              ...
              : document.selection && (t = document.selection);
            t &&
              (t.empty && t.empty(), t.removeAllRanges && t.removeAllRanges());
          }),
            ...
            (r = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    e &&
                      ((this.clearedCount = e.clearedCount),
              ...
              },
              {
                key: "captureState",
                value: function (t) {
                  var e = this.main.activeTool
                    ? this.main.activeTool.name
                    : null;
                  this.main.params.NON_SELECTABLE_TOOLS.includes(e) &&
                    (e = this.main.defaultTool.name);
                  var n = {
                  ...
                  null === this.current
                    ? ((n.prev = null),
                      ...
                      (this.clearedCount = 0))
                    : ((n.prev = this.current),
                      (n.prevCount = this.current.prevCount + 1),
                      (this.current.next = n)),
                    (n.next = null),
                    (this.current = n),
                    this.changed(t);
                ...
                value: function () {
                  if (null !== this.current.prev) {
                    ...
                    (this.current = this.current.prev),
                      ...
                      t
                        ? (this.main.closeActiveTool(!0),
                          this.main.setActiveTool(this.main.toolByName[t]))
                        : this.main.closeActiveTool(),
                      this.main.params.onUndo &&
                ...
                value: function (t) {
                  if (this.main.colorPicker.choosing && !t.altKey) {
                    ...
                    var e = this.main.getScale(),
                      ...
                      r = n[0] * e;
                    r =
                      (r = r < 1 ? 1 : r) > this.main.size.w - 1
                        ? this.main.size.w - 1
                        : r;
                    var o = n[1] * e;
                    o =
                      (o = o < 1 ? 1 : o) > this.main.size.h - 1
                        ? this.main.size.h - 1
                        : o;
                    for (
                      var i = this.captW, a = this.periodW, l = 0;
                      l < i;
                      l += 1
                    )
                      for (var A = 0; A < i; A += 1)
                        for (
                          var s = this.ctx.getImageData(
                              r + l - this.middle,
                              o + A - this.middle,
                              1,
                              1
                    ...
                    (this.zomer.style.left = "".concat(
                      t.clientX -
                        this.wrapper.documentOffsetLeft -
                        this.halfFullW,
                      "px"
                    )),
                      (this.zomer.style.top = "".concat(
                        t.clientY -
      ...
      731: function (t, e) {
        ...
        e.default = {
          ...
          fillPageWith:
            "Füllen Sie die Seite mit der aktuellen Hintergrundfarbe",
          pixelSize: "P",
      ...
      347: function (t, e) {
        ...
        e.default = {
          ...
          language: "Language",
          wrongPixelSizeValue:
            "Wrong pixel size. You can enter e.g. '20%' which mean pixel size will be 1/5 of the selected area side, or '4' means 4 px",
          tools: {
      ...
      103: function (t, e) {
        ...
        e.default = {
          ...
          language: "Langue",
          wrongPixelSizeValue:
            "Mauvaise taille de pixel. Vous pouvez ajouter par exemple e.g. '20%' ce qui signifie que la taille moyenne des pixels sera 1/5 de la surface sélectionnée, ou '4' signifie 4 px",
          tools: {
      ...
      401: function (t, e) {
        ...
        e.default = {
          ...
          language: "言語",
          wrongPixelSizeValue:
            'モザイクのサイズが正しくありません。次のように指定していください：\n "20%"（モザイクサイズは選択範囲の1/5になります）\n "4"（4pxを意味します）\n',
          tools: {
            crop: "切り抜き",
            pixelize: "モザイク",
            rect: "四角形を描く",
      ...
      711: function (t, e) {
        ...
        e.default = {
          ...
          language: "Taal",
          wrongPixelSizeValue:
            "Foute pixelgrootte. Je kunt b.v. '20%' invullen, wat een pixelgrootte van 1/5 van de geselecteerde gebiedszijde betekent, of '4' voor een pixelgrootte van 4 px",
          tools: {
      ...
      486: function (t, e) {
        ...
        e.default = {
          ...
          language: "Język",
          wrongPixelSizeValue:
            "Zły rozmiar pixela. Poprawne wartości to np. '20%', co oznacza przyjęcie rozmiaru pixela jako 20% pola wybranego obszaru, lub '4' jako 4 px",
          tools: {
      ...
      388: function (t, e) {
        ...
        e.default = {
          ...
          language: "Язык",
          wrongPixelSizeValue:
            "Неправильный размер пикселя. Вы можете ввести, например '20%', что означает, что средний размер пикселя будет 1/5 отстороны выбранной области или '4', что означает 4 пикселя",
          tools: {
          ...
          var n = (function () {
              return {
                ...
                resolveUrl: function (t, e) {
                  ...
                  return (
                    n.body.appendChild(o), (r.href = e), (o.href = t), o.href
                  );
                },
                  ...
                  return o instanceof Element
                    ? i(o).then(function () {
                        return o instanceof HTMLImageElement
                          ? t(o).inline()
                          : Promise.all(
                              n.asArray(o.childNodes).map(function (t) {
                                return e(t);
                              })
                            );
                      })
            ...
            return (
              (function (t) {
                void 0 === t.imagePlaceholder
                  ...
                  : (l.impl.options.imagePlaceholder = t.imagePlaceholder);
                void 0 === t.cacheBust
                  ? (l.impl.options.cacheBust = a.cacheBust)
                  : (l.impl.options.cacheBust = t.cacheBust);
              })((e = e || {})),
              Promise.resolve(t)
                .then(function (t) {
              ...
              ? Promise.resolve(t)
                  ...
                  .then(function (r) {
                    return (function (t, e, r) {
                      ...
                      return 0 === o.length
                        ? Promise.resolve(e)
                        : i(e, n.asArray(o), r).then(function () {
                            return e;
                          });
      ...
      891: function (t, e, n) {
        ...
        function B(t) {
          ...
          var n = e.userAgent,
            B = n.split("[FBAN");
          void 0 !== B[1] && (n = B[0]),
            void 0 !== (B = n.split("Twitter"))[1] && (n = B[0]);
          var v = (function (t) {
              return function (e) {
                return e.test(t);
              };
            ...
            w = {
              ...
              android: {
                ...
                device:
                  (!v(p) && (v(s) || v(c) || v(l) || v(A))) || v(/\bokhttp\b/i),
              },
              windows: {
                phone: v(p),
                tablet: v(h),
